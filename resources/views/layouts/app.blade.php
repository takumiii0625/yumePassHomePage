...
<body class="bg-gray-50">
    ...
    <header class="fixed top-0 left-0 w-full bg-white text-black py-6 shadow-lg z-50">
        <div class="max-w-7xl mx-auto px-4 flex justify-between items-center">
            <!-- ロゴ -->
            <a href="{{ url('/') }}" class="text-4xl font-extrabold hover:text-gray-600 transition duration-300">
                店舗パス
            </a>
            <!-- ナビゲーション -->
            <nav>
        ...
        <div class="max-w-7xl mx-auto px-4 text-center">
            ...
            <nav>
                <ul class="flex justify-center space-x-8 text-lg">
                    <li><a href="{{ url('/about') }}" class="hover:text-gray-400 transition duration-300">会社概要</a></li>
