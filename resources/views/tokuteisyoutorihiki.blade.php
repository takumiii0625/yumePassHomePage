...
<body class="antialiased">
    <div class="content-container">
        ...
        <p class=title>　OBFall株式会社が提供する夢パス（以下、「本アプリ」といいます。）の有償サブスクリプションサービスに関する特定商取引法に基づく表示は以下のとおりです。</p>
        ...
        <ol>
            ...
            <li>
                ...
                <p>夢パスは、モバイルアプリとしてお楽しみいただけます。</p>
                <p>動作環境は以下のとおりです。</p>

                <p>アプリ</p>
                <p>Android</p>
                <p>　- 夢パスバージョン1.0.0以降：Android 5.0以降</p>

                <p>iOS</p>
                <p>　- 夢パスバージョン1.0.0以降：iOS 11.0以降</p>
            </li>
            <li>
        ...
        <p style="text-align: right;">令和●年●月●日　制定</p>
