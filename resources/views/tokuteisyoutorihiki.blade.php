...
<body class="antialiased">
    <div class="content-container">
        ...
        <p class=title>　OBFall株式会社が提供するストパス（Store-Pass）（以下、「本アプリ」といいます。）の有償サブスクリプションサービスに関する特定商取引法に基づく表示は以下のとおりです。</p>
        ...
        <ol>
            ...
            <li>
                ...
                <p>ストパス（Store-Pass）は、モバイルアプリとしてお楽しみいただけます。</p>
                <p>動作環境は以下のとおりです。</p>

                <p>アプリ</p>
                <p>Android</p>
                <p>　- ストパス（Store-Pass）バージョン1.0.0以降：Android 5.0以降</p>

                <p>iOS</p>
                <p>　- ストパス（Store-Pass）バージョン1.0.0以降：iOS 11.0以降</p>
            </li>
            <li>
